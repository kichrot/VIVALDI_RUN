...
ModMenuHidden = function (e) {
	if ( document.querySelector(ModMenuSel) ) {
		ModMenucssText=ModMenucssText_0;
    	document.querySelector(ModMenuSel).style.cssText = ModMenucssText; //Скрываем  меню
...
function CreateNewButtonMenu(indexNewMenu, toolbarNewButton, titleNewButton, svgNewButton) {
    ...
    function openClick() {
    	ModMenucssText=ModMenucssText_0;
    	var ButtonModMenuSel = '#ButtonModMenu'+'_'+indexNewMenu;
		if (ModMenuSel != '' && ModMenuSel != 'div#ModMenu'+'_'+indexNewMenu)  {
 			document.querySelector(ModMenuSel).style.cssText = ModMenucssText; //Скрываем другую открытую панель
 		}		
 		ModMenuSel = 'div#ModMenu'+'_'+indexNewMenu;
        
        if (document.querySelector(ModMenuSel).style.visibility == "hidden") {
        	document.querySelector(ModMenuSel).style.cssText = ModMenucssText;
        	if (document.documentElement.clientHeight < (document.querySelector(ModMenuSel).getBoundingClientRect().top + document.querySelector(ModMenuSel).offsetHeight)) {
            	var ModMenuOffsetHeight = 0 - (document.querySelector(ModMenuSel).offsetHeight - document.querySelector(ButtonModMenuSel).offsetHeight) - 30;
            	ModMenucssText = ModMenucssText + ('top: ' + String(ModMenuOffsetHeight) + 'px;');
        	}
        	if (document.documentElement.clientWidth < (document.querySelector(ModMenuSel).getBoundingClientRect().left + document.querySelector(ModMenuSel).offsetWidth)) {
            	var ModMenuOffsetWidth = 0 - (document.querySelector(ModMenuSel).offsetWidth - document.querySelector(ButtonModMenuSel).offsetWidth);
            	ModMenucssText = ModMenucssText + ('left: ' + String(ModMenuOffsetWidth) + 'px;');
        	}        
             
        } else {
            document.querySelector(ModMenuSel).style.cssText = ModMenucssText + 'visibility: visible;';
        }
        if (document.querySelector(ModMenuSel).style.visibility == "hidden") { 
            document.querySelector(ModMenuSel).style.cssText = ModMenucssText + 'visibility: visible;'; //Показываем панель
    ...
    function NewButton() {
        ...
        outer_div.id = 'ButtonModMenu'+'_'+indexNewMenu;
        ...
        ModMenu.id = 'ModMenu'+'_'+indexNewMenu;
...
CreateNewButtonMenu(NewMenuIndex, NewButtonToolbar, NewButtonTitle, NewButtonSvg);
...
var NewItemToolbar = 'div#ModMenu_1';
var NewItemSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="scale: 0.6;"><path d="M20 19h-4v-4h4v4zm-6-10h-4v4h4v-4zm6 0h-4v4h4v-4zm-12 6h-4v4h4v-4zm16-14v22h-24v-22h24zm-2 6h-20v14h20v-14zm-8 8h-4v4h4v-4zm-6-6h-4v4h4v-4z"/></svg>';
...
var NewItem_KEYPRESS = '"15" |chrome://downloads| ';
var NewItemClass = 'mod_menu-downloads';
var NewItemToolbar = 'div#ModMenu_1';
var NewItemSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="scale: 0.6;"><path d="M16 11h5l-9 10-9-10h5v-11h8v11zm3 8v3h-14v-3h-2v5h18v-5h-2z"/></svg>';
...
var NewItem_KEYPRESS = '"15" |chrome://extensions| ';
var NewItemClass = 'mod_menu-extensions';
var NewItemToolbar = 'div#ModMenu_1';
var NewItemSvg = '<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.09 5c-1.031 0-1.825.912-1.825 1.937v1.318h-2.7C6.743 8.255 6 8.997 6 9.821v2.205h1.195c1 0 1.772.86 1.772 1.883 0 1.02-.769 1.846-1.772 1.846H6v2.68C6 19.257 6.742 20 7.566 20h2.679v-1.195c0-1.003.826-1.772 1.846-1.772 1.024 0 1.883.772 1.883 1.772V20h2.246c.824 0 1.566-.742 1.566-1.566v-2.7h1.277c1.025 0 1.937-.793 1.937-1.825 0-1.03-.91-1.862-1.937-1.862h-1.277V9.82c0-.824-.742-1.566-1.566-1.566h-2.267V6.937c0-1.027-.85-1.937-1.862-1.937z"></path></svg>';
...
var NewItemToolbar = 'div#ModMenu_1';
var NewItemSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="scale: 0.6;"><path d="M24 24l-6-5.269-6 5.269v-24h12v24zm-14-23h-10v2h10v-2zm0 5h-10v2h10v-2zm0 5h-10v2h10v-2zm0 5h-10v2h10v-2z"/></svg>';
...
var NewItemToolbar = 'div#ModMenu_1';
var NewItemSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="scale: 0.6;"><path d="M24 14v-4h-3.23c-.229-1.003-.624-1.94-1.156-2.785l2.286-2.286-2.83-2.829-2.286 2.286c-.845-.532-1.781-.928-2.784-1.156v-3.23h-4v3.23c-1.003.228-1.94.625-2.785 1.157l-2.286-2.286-2.829 2.828 2.287 2.287c-.533.845-.928 1.781-1.157 2.784h-3.23v4h3.23c.229 1.003.624 1.939 1.156 2.784l-2.286 2.287 2.829 2.829 2.286-2.286c.845.531 1.782.928 2.785 1.156v3.23h4v-3.23c1.003-.228 1.939-.624 2.784-1.156l2.286 2.286 2.828-2.829-2.285-2.286c.532-.845.928-1.782 1.156-2.785h3.231zm-12 2c-2.209 0-4-1.791-4-4s1.791-4 4-4 4 1.791 4 4-1.791 4-4 4z"/></svg>';
...
var NewItemToolbar = 'div#ModMenu_1';
var NewItemSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="scale: 0.6;"><path d="M22 2v20h-20v-20h20zm2-2h-24v24h24v-24zm-4 7h-8v1h8v-1zm0 5h-8v1h8v-1zm0 5h-8v1h8v-1zm-10.516-11.304l-.71-.696-2.553 2.607-1.539-1.452-.698.71 2.25 2.135 3.25-3.304zm0 5l-.71-.696-2.552 2.607-1.539-1.452-.698.709 2.249 2.136 3.25-3.304zm0 5l-.71-.696-2.552 2.607-1.539-1.452-.698.709 2.249 2.136 3.25-3.304z"/></svg>';
...
var NewItem_KEYPRESS = '"11" |taskmgr.exe| <Y> ';
var NewItemClass = 'mod_menu-TaskManagerWINDOWS';
var NewItemToolbar = 'div#ModMenu_1';
var NewItemSvg = '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="scale: 0.6;"><path d="M20 24h-20v-22h3c1.229 0 2.18-1.084 3-2h8c.82.916 1.771 2 3 2h3v9h-2v-7h-4l-2 2h-3.898l-2.102-2h-4v18h16v-5h2v7zm-10-4h-6v-1h6v1zm0-2h-6v-1h6v1zm6-5h8v2h-8v3l-5-4 5-4v3zm-6 3h-6v-1h6v1zm0-2h-6v-1h6v1zm0-2h-6v-1h6v1zm0-2h-6v-1h6v1zm-1-7c0 .552.448 1 1 1s1-.448 1-1-.448-1-1-1-1 .448-1 1z"/></svg>';
